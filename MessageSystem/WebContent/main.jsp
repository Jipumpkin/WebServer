			...
			<div id="wrapper">
				...
				<!-- Menu -->
					<nav id="menu">	
						<ul class="links">
							<li><h5>로그인</h5></li>
								<form action="LoginService" method="post">ㄹ
										 ...
										 <br><br>
  										  ...
  										  <% MessageDAO dao = new MessageDAO();
										       ...
										       for(int i=0; i<list.size(); i++) { %>
										        <%= list.get(i).getName() %>한테 온 메세지: <%= list.get(i).getContents() %>
										        <a href="MessageDeleteService?num=<%= list.get(i).getNum()%>" class="button next scrolly">개별삭제</a> <br><br>
										    <% } %>
