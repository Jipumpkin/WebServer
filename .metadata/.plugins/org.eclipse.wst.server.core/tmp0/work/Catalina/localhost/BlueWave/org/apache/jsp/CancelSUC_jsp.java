 ...
 * Generated at: 2024-07-30 10:57:02 UTC
...
public final class CancelSUC_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userId = user.getUserId(); // 사용자 ID 값을 JSP 변수로 가져옴
      ...
      out.write("		<!-- 텍스트 필드 -->\r\n");
      out.write("		<h2>\r\n");
      out.write("			회원탈퇴가 진행되었습니다.\r\n");
      out.write("		</h2>\r\n");
      out.write("		<h3>더 좋은 서비스로 발전하겠습니다.</h3><br><br>\r\n");
      out.write("			<!-- 메인페이지 이동 버튼 -->\r\n");
      out.write("			<button class=\"login-button\" onclick=\"redirectToMain()\">\r\n");
      out.write("				메인페이지로 이동</button>\r\n");
      out.write("\r\n");
      out.write("			<!-- 리다이렉트 알림 문구 -->\r\n");
      out.write("			<p class=\"redirect-message\">5초 후 리다이렉트됩니다.</p>\r\n");
      out.write("	</div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- 웹페이지 최하단 -->\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("// 페이지 로드 후 5초 후 메인 페이지로 리다이렉트\r\n");
